      ...
      <div class="text-center">
    	...
    	<div class="col-sm-9">
            <ul class="nav nav-tabs">
                ...
                <li><a data-toggle="tab" href="#messages">Mis Trabajos</a></li>
                ...
                <hr>
                  <form class="form" action="##" method="post" id="registrationForm">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-xs-6">
                            <label for="cuenta_bancaria"><h4>Cuenta Bancaria</h4></label>
                              <input type="text" class="form-control" name="cuenta_bancaria" id="cuenta_bancaria" placeholder="Cuenta bancaria" title="Ingrese su cuenta bancaria.">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-xs-6">
                            <label for="horario_trabajo"><h4>Horario de Trabajo</h4></label>
                              <input type="text" class="form-control" name="horario_trabajo" id="horario_trabajo" placeholder="Horario de trabajo" title="Ingrese su horario de trabajo.">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-xs-6">
                            <label for="zona_trabajo"><h4>Zona de Atencion</h4></label>
                              <input type="text" class="form-control" name="zona_trabajo" id="zona_trabajo" placeholder="Zona de Atencion" title="Ingrese la zona en la que atiende.">
                          </div>
                      </div>
